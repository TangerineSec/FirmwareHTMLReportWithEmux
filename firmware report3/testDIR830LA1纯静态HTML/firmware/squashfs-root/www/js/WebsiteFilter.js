...
Data.prototype = 
{
	...
	showWebsite: function()
	{
		...
		{
			outputString = '<input type="text" size="120" id="website'+this.rowid +'" onchange="datalist.editData('+this.rowid+', this.value)"/>';
		}
		else
		{
			outputString = '<input type="text" size="120" id="website'+this.rowid +'" value="'+encode_char(this.website)+'" onchange="datalist.editData('+this.rowid+', this.value)"/>';
		}

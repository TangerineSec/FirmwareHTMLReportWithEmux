...
document.write('<script type="text/javascript" charset="utf-8" src="/js/ConnectedClients.js' + ini_ver + '"></script>');
...
document.write('<script type="text/javascript" charset="utf-8" src="/js/AES.js' + ini_ver + '"></script>');
document.write('<script type="text/javascript" charset="utf-8" src="/js/configuration/DeviceConfig.js' + ini_ver + '"></script>');
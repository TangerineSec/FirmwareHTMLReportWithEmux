...
{
	var menu = "<ul>";
	if (DemoMode != 1)	{	menu	+= "	<li><a id='menu_Home' href='javascript:CheckHTMLStatus(\"Home\");' onclick='return confirmExit();'>"+I18N("j", "Home")+"</a></li>";			}
	else				{	menu	+= "	<li><a id='menu_Home' href='javascript:CheckHTMLStatus(\"Home_Demo\");' onclick='return confirmExit();'>"+I18N("j", "Home")+"</a></li>";	}
...
{	
	if (localStorage.getItem('language') == "ru-ru")	{	document.getElementById(menuId).style.background = "url(./image/navigation_bg6.gif?v=TimeStamp_QzwsxDcRfvTGByHn) right top no-repeat";	}
	else	{	document.getElementById(menuId).style.background = "url(./image/navigation_bg5.gif?v=TimeStamp_QzwsxDcRfvTGByHn) right top no-repeat";	}
}

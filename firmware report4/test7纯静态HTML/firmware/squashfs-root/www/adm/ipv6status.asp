...
function page_load() 
{
	var wanConnType = "<% nvram_get("lan_ipv6_mode"); %>";
	var wanConnType_Guest = "<% nvram_get("lan1_ipv6_mode"); %>";
//	var NetworkPrefix = "<% nvram_get("wan_ipv6_prefix"); %>";
	var NetworkPrefix = "<% nvram_get("lan_ipv6_prefix"); %>";
	var NetworkPrefix1 = "<% nvram_get("lan1_ipv6_prefix"); %>";
	var DNSServer = "<% nvram_get("lan_ipv6_dns"); %>";
	var DNSServerGuest = "<% nvram_get("lan1_ipv6_dns"); %>";

	if (wanConnType == "0") {
		document.getElementById("connectiontype").innerHTML = "<!--#tr id="disabled"-->Disabled<!--#endtr-->";
	}
//	if (wanConnType == "1" && NetworkPrefix[3] == '2') {
	if (wanConnType == "1") {
		document.getElementById("connectiontype").innerHTML = "<!--#tr id="ipv6.status.1"-->6to4<!--#endtr-->";
		document.getElementById("defaultgateway").innerHTML = "::192.88.99.1";
		document.getElementById("dnsserver").innerHTML = DNSServer;
		document.getElementById("networkstatus").innerHTML = "<!--#tr id="ipv6.status.2"-->Connected<!--#endtr-->";
		document.getElementById("networkprefix").innerHTML = NetworkPrefix;
	}
	
//	if (wanConnType == "2" && NetworkPrefix != "") {
	if (wanConnType == "2") {
		document.getElementById("connectiontype").innerHTML = "<!--#tr id="ipv6.status.native"-->Native IPv6<!--#endtr-->";
		document.getElementById("defaultgateway").innerHTML = "<% getLanIPv6Gw(); %>";
		document.getElementById("dnsserver").innerHTML = DNSServer;
		document.getElementById("networkstatus").innerHTML = "<!--#tr id="ipv6.status.2"-->Connected<!--#endtr-->";
		document.getElementById("networkprefix").innerHTML = NetworkPrefix;
	}
	
	if (wanConnType_Guest == "1" && NetworkPrefix1[3] == '2') {
		document.getElementById("connectiontype_guest").innerHTML = "<!--#tr id="ipv6.status.1"-->6to4<!--#endtr-->";
		document.getElementById("defaultgateway_guest").innerHTML = "::192.88.99.1";
		document.getElementById("dnsserver_guest").innerHTML = DNSServerGuest;
		document.getElementById("networkstatus_guest").innerHTML = "<!--#tr id="ipv6.status.2"-->Connected<!--#endtr-->";
		document.getElementById("networkprefix_guest").innerHTML = NetworkPrefix;
	}
	
	if (wanConnType_Guest == "2" && NetworkPrefix1 != "") {
		document.getElementById("connectiontype_guest").innerHTML = "<!--#tr id="ipv6.status.native"-->Native IPv6<!--#endtr-->";
		document.getElementById("dnsserver_guest").innerHTML = DNSServerGuest;
		document.getElementById("networkstatus_guest").innerHTML = "<!--#tr id="ipv6.status.2"-->Connected<!--#endtr-->";
		document.getElementById("networkprefix_guest").innerHTML = NetworkPrefix;
	}
...
<div class="hr" ></div>
<p>
<!--#tr id="ipv6.status.desc"-->The device IPv6 status.<!--#endtr-->
</p>

<!-- ================= IPv6 Internal Network Connection Information ================= -->
<table width="100%" class="tbl_main">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="ipv6.status.internal"-->IPv6 Internal Network Configurations<!--#endtr--></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="CL" id="NetworkPrefix"><!--#tr id="ipv6.status.network.prefix"-->Network Prefix<!--#endtr--></td>
		<td class="CR"><span id="networkprefix">&nbsp;</span></td>
	</tr>
	<tr>
		<td class="CL" id="DefaultGateway"><!--#tr id="ipv6.status.default.gateway"-->IPv6 Default Gateway<!--#endtr--></td>
		<td class="CR"><span id="defaultgateway">&nbsp;</span></td>
	</tr>
	<tr>
		<td class="CL" id="DNSServer"><!--#tr id="ipv6.status.dns"-->IPv6 DNS Server<!--#endtr--></td>
		<td class="CR"><span id="dnsserver">&nbsp;</span></td>
	</tr>
</table>
<!-- ================= IPv6 Guest Network Connection Information ================= -->
<table width="100%" class="tbl_main">
	<tr>
		<td class="CT" colspan="2"><!--#tr id="ipv6.status.guest"-->IPv6 Guest Network Configurations<!--#endtr--></td>
	</tr>
	<tr>
		<td class="CL" id="ConnectionTypeGuest"><!--#tr id="ipv6.status.connection.type"-->Connected Type<!--#endtr--></td>
		<td class="CR"><span id="connectiontype_guest">&nbsp;</span></td>
	</tr>
	<tr>
		<td class="CL" id="NetworkStatusGuest"><!--#tr id="ipv6.status.network"-->Network Status<!--#endtr--></td>
		<td class="CR"><span id="networkstatus_guest">&nbsp;</span></td>
	</tr>
	<tr>
		<td class="CL" id="NetworkPrefixGuest"><!--#tr id="ipv6.status.network.prefix"-->Network Prefix<!--#endtr--></td>
		<td class="CR"><span id="networkprefix_guest">&nbsp;</span></td>
	</tr>
	<tr>
		<td class="CL" id="DefaultGatewayGuest"><!--#tr id="ipv6.status.default.gateway"-->IPv6 Default Gateway<!--#endtr--></td>
		<td class="CR"><span id="defaultgateway_guest">&nbsp;</span></td>
	</tr>
	<tr>
		<td class="CL" id="DNSServerGuest"><!--#tr id="ipv6.status.dns"-->IPv6 DNS Server<!--#endtr--></td>
		<td class="CR"><span id="dnsserver_guest">&nbsp;</span></td>
	</tr>	
</table>

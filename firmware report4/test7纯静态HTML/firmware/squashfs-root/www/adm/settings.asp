...
function show_error()
{
	alert("<!--#tr id="sm.alert.1" -->Restore Configurations failed, please try again.<!--#endtr -->");
...
function reboot(tag)
{
	...
	if (tag == "import")
	{
		...
		if (confirm("<!--#tr id="sm.confirm.1"-->Are you sure you want to import configuration?<!--#endtr-->"))
		{
			document.getElementById("waitPad").style.display="block";
	...
	{
		document.getElementById("waitPad").style.display="block";
		if (confirm("<!--#tr id="sm.confirm.2"-->Are you sure load to factory default?<!--#endtr-->"))
		{
	...
	{
		document.getElementById("waitPad").style.display="block";
		if (confirm("<!--#tr id="sm.confirm.3"-->Are you sure reboot device?<!--#endtr-->"))
		{
			document.getElementById("waitPad").style.display="block";
...
<form method="post" id="LoadDefaultSettings" name="resetToDefault" action="/uapply.cgi" onsubmit="return reboot('loaddefault');">
<table width="100%" class="tbl_main">
	<tr>
	...
	<tr>
		...
		<td class="CR">
			...
			<input type="submit" class="button1_NoWidth" id="sm.btn.2" name="LoadDefault" value="<!--#tr id="sm.6"-->Load Default<!--#endtr-->">
		</td>
	</tr>
</table>
</form>

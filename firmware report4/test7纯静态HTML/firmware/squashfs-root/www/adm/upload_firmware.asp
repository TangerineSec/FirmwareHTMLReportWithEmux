...
function formCheck()
{
	...
	if(document.UploadFirmware.file.value == ""){
		alert("<!--#tr id="uf.alert.1"-->Firmware Upgrade: Please specify a file.<!--#endtr-->");
		return false;
	}

  if (confirm("<!--#tr id="uf.confirm.1"-->Are you sure upgrade firmware?<!--#endtr-->"))
  {
...
<form method="post" action="../upgrade.cgi" enctype="multipart/form-data" id="UploadFirmware" name="UploadFirmware" onsubmit="return formCheck();">
...
<table width="100%" class="tbl_main">
	...
	<tr align="center">
		<td colspan="2">
			<input type="submit" class="button1" id="UploadFirmwareSubmit" name="UploadFirmwareSubmit" value="<!--#tr id="apply"-->Apply<!--#endtr-->"> &nbsp; &nbsp;

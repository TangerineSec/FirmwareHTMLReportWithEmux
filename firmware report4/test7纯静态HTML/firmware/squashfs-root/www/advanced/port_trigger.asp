...
function pre_submit() {
	var i;
	for (i = 0; i < document.getElementById("autofw_port").value; i++) {
		document.getElementById("autofw_port_to_start" + i).value = document.getElementById("autofw_port_in_start" + i).value;
		document.getElementById("autofw_port_to_end" + i).value = document.getElementById("autofw_port_in_end" + i).value;
	}
}
...
function applyCheck()
{
    ...
    for (var i = 0; i < TOTAL; i++)
    {
        ...
        {
            matchStartPortElement.focus();
            alert("<!--#tr id="trigger.alert.1"-->Match Start port should be less than Match End Port<!--#endtr-->");
            return false;
        } 
        else if (parseInt(triggerStartPortElement.value) > parseInt(triggerEndPortElement.value))
        {
            triggerStartPortElement.focus();
            alert("<!--#tr id="trigger.alert.2"-->Trigger Start port should be less than Trigger End Port<!--#endtr-->");
            return false;
        }   
    }
...
<table width="100%" class="tbl_main">
	...
	<tr>
		...
		<td class="CR">
		  <select id="autofw_port_enable" name="autofw_port_enable">
	...
	<tr>
		<td>
			<table width="100%" class="tbl_main2">
				...
				<!--    <td class="form_list_title">&nbsp;</td>
					<td class="form_list_title">Match<br>Port End</td>-->
					<td style="display:none">&nbsp;</td>
				...
				<!--    <td class="form_list_title">&nbsp;</td>
					<td class="form_list_title">Trigger<br>Port End</td>-->
					<td style="display:none">&nbsp;</td>
					<td class="form_list_title" style="display:none">To<br>Port Start</td>
					<td style="display:none"></td>
					<td class="form_list_title" style="display:none">To<br>Port End</td>
					<td style="display:none">&nbsp;</td>
...
<table width="100%" class="tbl_main">
	<tr align="center">
		<td>
			<input type="submit" class="button1" name="action" value="<!--#tr id="apply"-->Apply<!--#endtr-->" onClick="pre_submit()">

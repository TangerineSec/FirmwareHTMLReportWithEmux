...
function pre_submit() {
	var i;
	for (i = 0; i < document.getElementById("forward_port").value; i++) {
		document.getElementById("forward_port_from_end" + i).value = document.getElementById("forward_port_from_start" + i).value;
		document.getElementById("forward_port_to_end" + i).value = document.getElementById("forward_port_to_start" + i).value;
	}
}
    ...
    for (var i = 0; i < TOTAL-1; i++) {
		...
		for(var j = i+1; j < TOTAL; j++) {
			...
			if ((chk1_port.value == chk2_port.value) && (protocol_1 == protocol_2)){
				chk2_port.focus();
				alert("<!--#tr id="port.error.2"-->The public port number is already used. Please assign a different port number.<!--#endtr-->");
				return false;
			}
		}
	}
...
<form method="post" name="forward_port_form" action="/uapply.cgi" onSubmit="return applyCheck();">
...
<table width="100%" class="tbl_main">
	...
	<tr>
		...
		<td class="CR">
			<select id="forward_port_enable" name="forward_port_enable">
		...
		<td>
			<table width="100%" class="tbl_main2">
				<tr>
					...
					<td class="form_list_title" style="display:none">WAN Port<br>End</td>
					...
					<td class="form_list_title" style="display:none">LAN Port<br>End</td>
...
<table width="100%" class="tbl_main">
	<tr align="center">
		<td>
			<input type="submit" class="<!--#tr id="buttonWidth"-->button1<!--#endtr-->" name="action" value="<!--#tr id="apply"-->Apply<!--#endtr-->" onClick="pre_submit()">
